...
critiques étant les États-unis et la France~\citep[p. 503]{Mazbouri12}. Dans la deuxième partie du XXe
siècle, la diplomatie américaine obtient de la Suisse quelques concessions qui
...
d’articles des deux journaux sera filtré de façon tel que les articles
contiennent des mots clés, repérés à travers l’analyse d’autres sources
...
suisse” CIT où les conséquences internationales et intérieures du secret
bancaire sont dénoncé. Cet ouvrage nous expose au discour qui entourait le sujet
pendants les années 70s et 80s. Un nombre de scandale pertinents au secret
bancaire en sont les protagonistes.

Les sources juridiques nous témoignent un conflit entre la Suisse et pays
étranger en fait de secret bancaire. La sentence “CIT tribunal federal” en
faveur du maintien du secret bancaire en 1969 nous montre que la loi est
appliqué avec véhémence.

Les États Unis rejoindrons enfin une entente avec la Suisse sur le secret
bancaire, comme témoigné par (CIT memorandum on insider trading) et (CIT 1974
entente).

L’histoire financière suisse a été étudié extensivement par Sébastien Guex et
Malik Mazbouri. Les aspects juridiques du secret bancaire ont été étudié en 1969
par Mueller. La spécificité du cas suisse à niveau international est analysé par
Meier et al. (TOUT CITER)
...
se suivent souvent, et quelle est leur connotation). Nous voulons aussi nous
intéresser aux outils d’analyse de texte plus récents qui peuvent permettre par
exemple de dégager une impression du texte (s’il est plutôt positif ou non),
afin de tenter de pouvoir visualiser l’opinion de la rédaction sur les articles
qui abordent le sujet au fil du temps.
